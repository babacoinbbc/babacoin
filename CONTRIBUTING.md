Contributing to Babacoin Core
============================

The Babacoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Raptor3um/babacoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Babacoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Babacoin
Network Protocol consensus changes.

Whether a pull request is merged into Babacoin Core rests with the project merge
...
Patches that change Babacoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Babacoin consensus, it must have been
...
The review process is normally fairly responsive on the Babacoin Core repository, however
...
The project leader is the release manager for each Babacoin Core release.
