...
from test_framework.test_framework import BabacoinTestFramework
...
class LLMQChainLocksTest(BabacoinTestFramework):
    def set_test_params(self):
        self.set_babacoin_test_params(6, 5, fast_dip3_enforcement=True)
