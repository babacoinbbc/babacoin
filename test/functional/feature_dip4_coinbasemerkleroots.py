...
class LLMQCoinbaseCommitmentsTest(BabacoinTestFramework):
    def set_test_params(self):
        self.set_babacoin_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as BabacoinTestFramework doesn't support this atm)
