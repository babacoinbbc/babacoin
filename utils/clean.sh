...
rm -f src/config/babacoin-config.h
...
rm -rf test_bitcoin.coverage/ babacoin-gtest.coverage/ total.coverage/
...
clean_exe src/babacoin-cli
clean_exe src/babacoind
clean_exe src/babacoin-gtest
clean_exe src/babacoin-tx
clean_exe src/test/test_babacoin
clean_exe src/test/test_babacoin_fuzzy
...
clean_dep . src/config/babacoin-config.h.in
