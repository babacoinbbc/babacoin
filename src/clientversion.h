...
#error Client version information missing: version is not defined by babacoin-config.h or in any other way
#endif
...
/**
 * babacoind-res.rc includes this file, but it cannot cope with real c++ code.
