...
#ifndef BABACOIN_ARITH_UINT256_H
#define BABACOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Babacoin only uses this "compact" format for encoding difficulty
...
#endif // BABACOIN_ARITH_UINT256_H
