...
//! Interface for the src/evo part of a babacoin node (babacoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a babacoin node (babacoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a babacoin node (babacoind process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a babacoin node (babacoind process).
class Node
{
public:
    virtual ~Node() {}
