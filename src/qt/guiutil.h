...
/** Utility functions used by the Babacoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "babacoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load babacoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a babacoin specific theme is activated (light/dark).*/
