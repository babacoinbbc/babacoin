...
This mechanism has been integrated into Bitcore-Node-Babacoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/babacoin/insight-api-babacoin#web-socket-api](https://github.com/babacoin/insight-api-babacoin#web-socket-api)
* API: [https://github.com/babacoin/insight-api-babacoin#instantsend-transactions](https://github.com/babacoin/insight-api-babacoin#instantsend-transactions)
