...
* babacoin.conf: contains configuration settings for babacoind or babacoin-qt
* babacoind.pid: stores the process id of babacoind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by babacoind or babacoin-qt
